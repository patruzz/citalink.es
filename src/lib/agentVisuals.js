...
export const agentVisuals = {
  email: visual({
    ...
    scene: `
      ...
      <path d="M430 120 h92 a24 24 0 0 1 24 24 v62 a24 24 0 0 1-24 24 h-92 a24 24 0 0 1-24-24 v-62 a24 24 0 0 1 24-24Z" fill="#0f172a" stroke="#2dd4bf"/>
      <path d="M424 144 l52 38 54-38" fill="none" stroke="#2dd4bf" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/>
    `,
  }),
  phone: visual({
    title: 'Phone SDR',
    ...
    secondary: '#2dd4bf',
    scene: `
      <circle cx="204" cy="180" r="78" fill="#0f172a" stroke="#f59e0b"/>
      ...
      <path d="M480 116 q44 64 0 128" fill="none" stroke="#2dd4bf" stroke-width="10" stroke-linecap="round" opacity=".75"/>
    `,
  }),
  qualifier: visual({
    title: 'Qualifier',
    ...
    scene: `
      ...
      <path d="M143 244 h40 M287 244 h64 M431 244 h36" stroke="#2dd4bf" stroke-width="8" stroke-linecap="round"/>
    `,
  }),
  scheduler: visual({
    title: 'Scheduler',
    ...
    scene: `
      ...
      <rect x="360" y="208" width="90" height="28" rx="8" fill="#1e293b" stroke="#60a5fa"/>
      <path d="M480 120 l34 34 70-76" fill="none" stroke="#2dd4bf" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"/>
    `,
  }),
  compliance: visual({
    title: 'Compliance',
    ...
    secondary: '#60a5fa',
    scene: `
      <path d="M320 72 l132 42 v78 c0 70-48 118-132 148-84-30-132-78-132-148v-78Z" fill="#0f172a" stroke="#22c55e" stroke-width="6"/>
      <path d="M266 190 l38 38 78-92" fill="none" stroke="#22c55e" stroke-width="18" stroke-linecap="round" stroke-linejoin="round" filter="url(#glow)"/>
      <rect x="72" y="118" width="112" height="26" rx="8" fill="#1f2937"/>
      <rect x="456" y="240" width="112" height="26" rx="8" fill="#1f2937"/>
      <circle cx="118" cy="204" r="26" fill="#111827" stroke="#60a5fa"/>
      <circle cx="522" cy="150" r="26" fill="#111827" stroke="#f59e0b"/>
    `,
  }),
};
